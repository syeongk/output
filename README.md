...
## 📌 프로젝트 소개
아웃풋은 구직자들이 면접 준비 과정에서 겪는 어려움을 해결하기 위해 개발된 AI 기반의 모의 면접 앱입니다.
...
## 🏗️  서비스 아키텍처
> Flutter 기반의 클라이언트가 Nginx를 통해 Spring Boot 백엔드와 통신하는 구조입니다. 백엔드는 MySQL 데이터베이스와 연동되며, Google OAuth 및 OpenAI API를 활용하여 AI 질문 생성, 피드백 등의 핵심 기능을 처리합니다. 모든 서버 컴포넌트는 Docker 컨테이너를 통해 kt cloud 환경에 배포됩니다.
