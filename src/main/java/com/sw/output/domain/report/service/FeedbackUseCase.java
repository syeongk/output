...
public class FeedbackUseCase {
    ...
    @Transactional
    public OpenAIDTO.AiFeedbackDTO prepareAIFeedback(Long reportId, ReportRequestDTO.CreateAiFeedbackDTO createAiFeedbackDTO) {
    ...
    public void createAIFeedback(Long reportId, ReportRequestDTO.CreateAiFeedbackDTO createAiFeedbackDTO) {
        OpenAIDTO.AiFeedbackDTO aiFeedbackDTO = prepareAIFeedback(reportId, createAiFeedbackDTO);
        openAIService.processAIFeedback(createAiFeedbackDTO.getMemberAnswer(), aiFeedbackDTO.getQuestionAnswer().getQuestionTitle(), aiFeedbackDTO.getFeedback());
    }
}
