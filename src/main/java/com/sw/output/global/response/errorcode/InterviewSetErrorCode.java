...
public enum InterviewSetErrorCode implements BaseCode {
    ...
    INVALID_TITLE_LENGTH(HttpStatus.BAD_REQUEST, "INTERVIEW_SET_4006", "제목은 1-50자 사이여야 합니다."),
    INTERVIEW_SET_DELETED(HttpStatus.NOT_FOUND, "INTERVIEW_SET_4007", "삭제된 면접 세트입니다."),
    ;
